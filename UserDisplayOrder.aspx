<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.Master" AutoEventWireup="true" CodeBehind="UserDisplayOrder.aspx.cs" Inherits="KG.UserDisplayOrder" %>
        ...
        <div class="row">
            <asp:GridView ID="GridView1" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="5" CssClass="table table-responsive table-bordered table-condensed table-hover" GridLines="None" runat="server" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <a href="UserViewOrder.aspx?DA_id=<%#Eval("DA_id") %>">
